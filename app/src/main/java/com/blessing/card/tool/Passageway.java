package com.blessing.card.tool;
...
import com.blessing.card.activity.ImageListActivity;
...
public class Passageway {
     ...
     * @param cls
     */
    public static void jumpToActivity(Context context, Class<ImageListActivity> cls) {
